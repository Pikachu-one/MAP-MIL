...
class WiKG(nn.Module):
    def __init__(self, conf, dim_in=1024, dim_hidden=512, topk=6, n_classes=2, agg_type='bi-interaction', dropout=0.3, pool='attn'):
        super().__init__()
        self._fc1 = nn.Sequential(nn.Linear(conf.D_feat, dim_hidden), nn.LeakyReLU())
...
if __name__ == "__main__":
    ...
    model = WiKG( dim_hidden=512, topk=6, n_classes=2, agg_type='bi-interaction', dropout=0.3, pool='mean').cuda()
    model.eval()
