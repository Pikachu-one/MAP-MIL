...
class TransMIL(nn.Module):
    def __init__(self, input_dim, n_classes,dropout,act):
        ...
        self.layer1 = TransLayer1(dim=512)
        self.layer2 = TransLayer1(dim=512)
        self.norm = nn.LayerNorm(512)
        self._fc2 = nn.Linear(512, self.n_classes)

        self.apply(initialize_weights)

    def forward(self, x, pseudo_bag=False):
...
if __name__ == "__main__":
    ...
    model = TransMIL(input_dim=1024,n_classes=2,dropout=False,act='relu')
